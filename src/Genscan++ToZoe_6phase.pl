...
open(IN, $infile);
open(CONSEQ, $conseq_file);
open(INFO, $isochore_info);
...
#foreach my $pair (@info) {
    ...
    open(OUT, ">${base_name}_iso${iso_counter}.zhmm");
...
# need to put internal states here, need their initial probs
    ...
    print OUT "
Inter		Internal + 0   Inter   Inter  	$InitialProbibility{'N'}{$isochore}
...
Eterm1-    Intron1-              $TransistionMatrixMunge{'Eterm-'}{'I2-'}{'none'}
Eterm1T-   Intron1T-             $TransistionMatrixMunge{'Eterm-'}{'I2-'}{'none'}
Eterm2-    Intron2-              $TransistionMatrixMunge{'Eterm-'}{'I1-'}{'none'}
Eterm2TA-  Intron2TA-            $TransistionMatrixMunge{'Eterm-'}{'I1-'}{'none'}
Eterm2TG-  Intron2TG-            $TransistionMatrixMunge{'Eterm-'}{'I1-'}{'none'}
Inter      PolyA-                $TransistionMatrixMunge{'N'}{'A-'}{'none'}
PolyA-	   Utr3-                 1.0
Intron0-   Exon0-                $TransistionMatrix{'I0-'}{'E0-'}{$isochore}
Intron0-   Exon1-                $TransistionMatrix{'I2-'}{'E0-'}{$isochore}
Intron0-   Exon1T-               $TransistionMatrix{'I2-'}{'E0-'}{$isochore}
Intron0-   Exon2-                $TransistionMatrix{'I1-'}{'E0-'}{$isochore}
Intron0-   Exon2TA-              $TransistionMatrix{'I1-'}{'E0-'}{$isochore}
Intron0-   Exon2TG-              $TransistionMatrix{'I1-'}{'E0-'}{$isochore}
Intron1-   Exon0-                $TransistionMatrix{'I0-'}{'E2-'}{$isochore}
Intron1T-  Exon0-                $TransistionMatrix{'I0-'}{'E2-'}{$isochore}
Intron1-   Exon1-                $TransistionMatrix{'I2-'}{'E2-'}{$isochore}
Intron1-   Exon1T-               $TransistionMatrix{'I2-'}{'E2-'}{$isochore}
Intron1T-  Exon1-                $TransistionMatrix{'I2-'}{'E2-'}{$isochore}
Intron1T-  Exon1T-               $TransistionMatrix{'I2-'}{'E2-'}{$isochore}
...
Intron2-   Exon0-                $TransistionMatrix{'I0-'}{'E1-'}{$isochore}
Intron2TA- Exon0-                $TransistionMatrix{'I0-'}{'E1-'}{$isochore}
Intron2TG- Exon0-                $TransistionMatrix{'I0-'}{'E1-'}{$isochore}
...
Intron2-   Exon2-                $TransistionMatrix{'I1-'}{'E1-'}{$isochore}
Intron2-   Exon2TA-              $TransistionMatrix{'I1-'}{'E1-'}{$isochore}
Intron2-   Exon2TG-              $TransistionMatrix{'I1-'}{'E1-'}{$isochore}
Intron2TA- Exon2-                $TransistionMatrix{'I1-'}{'E1-'}{$isochore}
Intron2TA- Exon2TA-              $TransistionMatrix{'I1-'}{'E1-'}{$isochore}
Intron2TA- Exon2TG-              $TransistionMatrix{'I1-'}{'E1-'}{$isochore}
Intron2TG- Exon2-                $TransistionMatrix{'I1-'}{'E1-'}{$isochore}
Intron2TG- Exon2TA-              $TransistionMatrix{'I1-'}{'E1-'}{$isochore}
Intron2TG- Exon2TG-              $TransistionMatrix{'I1-'}{'E1-'}{$isochore}
Intron0-   Einit-                $TransistionMatrixMunge{'I0-'}{'Einit-'}{$isochore}
Intron1-   Einit-                $TransistionMatrixMunge{'I2-'}{'Einit-'}{$isochore}
Intron1T-  Einit-                $TransistionMatrixMunge{'I2-'}{'Einit-'}{$isochore}
Intron2-   Einit-                $TransistionMatrixMunge{'I1-'}{'Einit-'}{$isochore}
Intron2TA- Einit-                $TransistionMatrixMunge{'I1-'}{'Einit-'}{$isochore}
Intron2TG- Einit-                $TransistionMatrixMunge{'I1-'}{'Einit-'}{$isochore}
Exon0-     Intron0-              1.0
Exon1-     Intron1-              1.0
Exon1T-    Intron1T-             1.0
Exon2-     Intron2-              1.0
